...
urlpatterns = [
    ...
    path('HeatmapPage/', views.HeatmapPage, name='HeatmapPage'),
    path('dapinfPage/', views.dapinfPage, name='dapinfPage'),
    # ***************************************************************************#
    path('index/messageMain/', messageMain, name='messageMain'),
